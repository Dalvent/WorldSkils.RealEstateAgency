...
public class RealtorEventAdapter extends BaseAdapter {
    private AbstractRepository<RealtorEvent> repository;
    private List<RealtorEvent> events;
    private LayoutInflater layoutInflater;

    public RealtorEventAdapter(AbstractRepository<RealtorEvent> repository, List<RealtorEvent> events, LayoutInflater layoutInflater) {
